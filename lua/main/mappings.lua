...
local buffer_line = require 'plugins.buffer_line'
...
map('n', '<c-w>,', buffer_line.prev_buffer, { silent=true }) -- Previous buffer
map('n', '<c-w>.', buffer_line.next_buffer, { silent=true }) -- Next buffer
map('n', '<c-w>d', buffer_line.delete_buffer, { silent=true }) -- Close buffer
