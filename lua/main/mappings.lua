...
local buffer = require 'plugins.buffer'
...
map('n', '<c-w>d', buffer.delete_buffer, { silent=true }) -- Close buffer
map('n', '<c-s>', ':w<cr>', { silent=true }) -- Save file
map('i', '<c-s>', '<c-o>:w<cr>', { silent=true }) -- Save file
map('n', '<leader>=', '<c-a>', { silent=true }) -- Increment
map('v', '<leader>=', '<c-a>', { silent=true }) -- Increment
map('n', '<leader>-', '<c-x>', { silent=true }) -- Decrement
map('v', '<leader>-', '<c-x>', { silent=true }) -- Decrement
map('n', '<c-a>', 'ggVG', { silent=true }) -- Select all
map('v', '<c-a>', '<esc>ggVG', { silent=true }) -- Select all
map('i', '<c-a>', '<esc>ggVG', { silent=true }) -- Select all
map('v', '<c-c>', clipboard.copy, { silent=true }) -- Copy
map('v', '<c-x>', clipboard.cut, { silent=true }) -- Cut
map('i', '<c-v>', clipboard.paste, { silent=true }) -- Paste
map('n', '<c-v>', clipboard.paste, { silent=true }) -- Paste
...
map('n', '<c-w>h', tmux_navigator.tmux_navigate_left, { silent=true }) -- Navigate left
map('n', '<c-w>j', tmux_navigator.tmux_navigate_down, { silent=true }) -- Navigate down
map('n', '<c-w>k', tmux_navigator.tmux_navigate_up, { silent=true }) -- Navigate right
map('n', '<c-w>l', tmux_navigator.tmux_navigate_right, { silent=true }) -- Navigate up
map('t', '<c-w>h', tmux_navigator.tmux_navigate_left, { silent=true }) -- Navigate left (terminal)
map('t', '<c-w>j', tmux_navigator.tmux_navigate_down, { silent=true }) -- Navigate down (terminal)
map('t', '<c-w>k', tmux_navigator.tmux_navigate_up, { silent=true }) -- Navigate right (terminal)
map('t', '<c-w>l', tmux_navigator.tmux_navigate_right, { silent=true }) -- Navigate up (terminal)
map('n', '<leader>u', fold.toggle, { silent=true }) -- Toggle fold
map('n', '<c-w>,', tabs.prev_tab, { silent=true }) -- Previous tab
map('n', '<c-w>.', tabs.next_tab, { silent=true }) -- Next tab
