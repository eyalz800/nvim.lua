...
m.setup = function()
    ...
    local mappings = {
        n = {
            ...
            ['<leader><c-p>'] = { finder.find_file_rg, 'Find file (fuzzy) with rg (finder.find_file_rg)' },
            ['<leader>fc'] = { finder.find_file_list, 'Find file with cache (finder.find_file_list)' },
            ['<leader><leader>fc'] = { finder.find_file_list_invalidate, 'Find file (invalidate cache) (finder.find_file_list_invalidate)' },
            ['<c-]>'] = { finder.find_file_hidden, 'Find hidden file (finder.find_file_hidden)' },
            ['<leader><c-]>'] = { finder.find_file_hidden_rg, 'Find hidden file with rg (finder.find_file_hidden_rg)' },
            ['<leader>fhc'] = { finder.find_file_list_hidden, 'Find hidden file with cache (finder.find_file_list_hidden)' },
            ['<leader><leader>fhc'] = { finder.find_file_list_hidden_invalidate, 'Find hidden file (invalidate cache) (finder.find_file_list_hidden_invalidate)' },
            ...
            ['grxd'] = { source_index.clean, 'Clean source index (clean)' },
