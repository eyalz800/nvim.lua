...
m.setup = function()
    ...
    local mappings = {
        n = {
            ...
            ['<c-q>'] = { '<c-v>', 'Visual block mode (Ctrl-V)' },
            ...
            ['L'] = { '<cmd>vertical resize +1<cr>', 'Increase window width (vertical resize +1)' },
            ['H'] = { '<cmd>vertical resize -1<cr>', 'Decrease window width (vertical resize -1)' },
            ...
            ['cq'] = { explorers.display_current_directory, 'Show current directory path (explorers.display_current_directory)' },
            ...
            ['gv'] = { '<cmd>DiffviewFileHistory %<cr>', 'Show diff view for current file (DiffviewFileHistory %)' },
            ['gV'] = { '<cmd>DiffviewFileHistory<cr>', 'Show diff view for current branch (DiffviewFileHistory)' },
            ['gl'] = { git.show_git, 'Show git status (git.show_git)' },
            ['gm'] = { git.show_staging_buffer, 'Show git staging buffer (git.show_staging_buffer)' },
            ['[c'] = { git.prev_hunk, 'Go to previous git hunk (git.prev_hunk)' },
            [']c'] = { git.next_hunk, 'Go to next git hunk (git.next_hunk)' },
            ...
            ['ga'] = { lsp.code_action, 'Show LSP code actions (lsp.code_action)' },
            ...
            ['<c-w>,'] = { 'Previous buffer (go to previous buffer)' },
            ...
            ['<leader>ca'] = { source_index.cscope_assignments, 'CScope: find assignments (cscope_assignments)' },
            ['<leader>cc'] = { source_index.cscope_function_calling, 'CScope: find function calling (cscope_function_calling)' },
            ['<leader>cd'] = { source_index.cscope_functions_called_by, 'CScope: find functions called by (cscope_functions_called_by)' },
            ['<leader>ce'] = { source_index.cscope_egrep, 'CScope: egrep (cscope_egrep)' },
            ['<leader>cf'] = { source_index.cscope_file, 'CScope: find file (cscope_file)' },
            ['<leader>cg'] = { source_index.cscope_definition, 'CScope: find definition (cscope_definition)' },
            ['<leader>ci'] = { source_index.cscope_files_including, 'CScope: find files including (cscope_files_including)' },
            ['<leader>cs'] = { source_index.cscope_symbol, 'CScope: find symbol (cscope_symbol)' },
            ['<leader>ct'] = { source_index.cscope_text, 'CScope: find text (cscope_text)' },
            ['<leader><leader>ca'] = { source_index.cscope_assignments, 'CScope: find assignments (input) (cscope_assignments)' },
            ['<leader><leader>cc'] = { source_index.cscope_input_function_calling, 'CScope: find function calling (input) (cscope_input_function_calling)' },
            ['<leader><leader>cd'] = { source_index.cscope_input_functions_called_by, 'CScope: find functions called by (input) (cscope_input_functions_called_by)' },
            ['<leader><leader>ce'] = { source_index.cscope_input_egrep, 'CScope: egrep (input) (cscope_input_egrep)' },
            ['<leader><leader>cf'] = { source_index.cscope_input_file, 'CScope: find file (input) (cscope_input_file)' },
            ['<leader><leader>cg'] = { source_index.cscope_input_definition, 'CScope: find definition (input) (cscope_input_definition)' },
            ['<leader><leader>ci'] = { source_index.cscope_input_files_including, 'CScope: find files including (input) (cscope_input_files_including)' },
            ['<leader><leader>cs'] = { source_index.cscope_input_symbol, 'CScope: find symbol (input) (cscope_input_symbol)' },
            ['<leader><leader>ct'] = { source_index.cscope_input_text, 'CScope: find text (input) (cscope_input_text)' },
            ...
            ['<leader>gcp'] = { source_index.generate_cpp, 'Generate C++ index (generate_cpp)' },
            ['<leader>gt'] = { source_index.generate_tags, 'Generate tags (generate_tags)' },
            ['<leader>gT'] = { source_index.generate_all_tags, 'Generate all tags (generate_all_tags)' },
            ['<leader>gf'] = { source_index.generate_source_files_list, 'Generate source files list/cache (generate_source_files_list)' },
            ['<leader>gF'] = { source_index.generate_all_files_list, 'Generate all files list/cache (generate_all_files_list)' },
            ['<leader>gcf'] = { source_index.generate_flags, 'Generate flags (generate_flags)' },
            ['<leader>go'] = { source_index.generate_opengrok, 'Generate opengrok index (generate_opengrok)' },
            ['<leader>ga'] = { source_index.generate_cpp_and_opengrok, 'Generate C++ and opengrok index (generate_cpp_and_opengrok)' },
            ...
            ['<leader><leader>lf'] = { '<cmd>lua require "plugins.large_files".set()<cr>', 'Set large file mode (plugins.large_files.set)' },
