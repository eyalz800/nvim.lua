...
m.config = function()
    ...
    return {
        ...
        highlights = {
            ...
            separator_selected = { fg = line_bg, bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            trunc_marker = { fg = fg, bg = line_bg },
            background = { fg = fg, bg = bg },
            buffer_visible = { fg = visible_fg, bg = visible_bg },
            buffer_selected = { fg = selected_fg, bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            duplicate = { fg = fg, bg = bg },
            duplicate_visible = { fg = visible_fg, bg = visible_bg },
            duplicate_selected = { fg = selected_fg, bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            close_button = { fg = fg, bg = bg },
            close_button_visible = { fg = visible_fg, bg = visible_bg },
            close_button_selected = { fg = selected_fg, bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            tab = { fg = fg, bg = bg },
            tab_selected = { fg = selected_fg, bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            tab_separator = { fg = line_bg, bg = bg },
            tab_separator_selected = { fg = line_bg, bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            tab_close = { fg = fg, bg = line_bg },
            numbers = { fg = fg, bg = bg },
            numbers_visible = { fg = visible_fg, bg = visible_bg },
            numbers_selected = { fg = selected_fg, bg = selected_bg, underline = underline_enabled, sp = underline_sp },

            modified = { bg = bg },
            modified_visible = { bg = visible_bg },
            modified_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            pick = { bg = bg },
            pick_visible = { bg = visible_bg },
            pick_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            indicator_visible = { bg = visible_bg },
            indicator_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },

            diagnostic = { bg = bg },
            diagnostic_visible = { bg = visible_bg },
            diagnostic_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            hint = { bg = bg },
            hint_visible = { bg = visible_bg },
            hint_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            info = { bg = bg },
            info_visible = { bg = visible_bg },
            info_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            info_diagnostic = { bg = bg },
            info_diagnostic_visible = { bg = visible_bg },
            info_diagnostic_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            warning = { bg = bg },
            warning_visible = { bg = visible_bg },
            warning_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            warning_diagnostic = { bg = bg },
            warning_diagnostic_visible = { bg = visible_bg },
            warning_diagnostic_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            error = { bg = bg },
            error_visible = { bg = visible_bg },
            error_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },
            error_diagnostic = { bg = bg },
            error_diagnostic_visible = { bg = visible_bg },
            error_diagnostic_selected = { bg = selected_bg, underline = underline_enabled, sp = underline_sp },
        },
    }
end
